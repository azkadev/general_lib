...
class DockerPlugin extends JsonScheme {
  DockerPlugin(super.rawData);

  static Map get defaultData {
    return {"@type": "DockerPlugin", "name": "", "script": ""};
  }
  ...
  String? get script {
    try {
      if (rawData["script"] is String == false) {
        return null;
      }
      return rawData["script"] as String;
    } catch (e) {
      return null;
    }
  }
